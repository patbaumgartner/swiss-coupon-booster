...
public class RestClientConfiguration {
	...
	RestClient.Builder restClientBuilder() {
		...
		return RestClient.builder()
			...
			.defaultHeader(ApplicationConstants.HttpHeaders.USER_AGENT_HEADER,
					ApplicationConstants.ApplicationInfo.DEFAULT_USER_AGENT);
	}
	...
	RestClientCustomizer restClientCustomizer() {
		...
		return restClientBuilder -> restClientBuilder
			.defaultHeader(ApplicationConstants.HttpHeaders.ACCEPT_ENCODING_HEADER, "gzip, deflate, br")
			.defaultHeader(ApplicationConstants.HttpHeaders.CONNECTION_HEADER, "keep-alive");
	}
