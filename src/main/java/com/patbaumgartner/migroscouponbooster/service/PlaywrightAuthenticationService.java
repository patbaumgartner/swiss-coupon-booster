...
import com.patbaumgartner.migroscouponbooster.properties.MigrosSelectorsProperties;
import com.patbaumgartner.migroscouponbooster.properties.MigrosUserProperties;
import com.patbaumgartner.migroscouponbooster.properties.PlaywrightProperties;
import com.patbaumgartner.migroscouponbooster.util.WebAuthnDisabler;
 ...
 */
@Service
public class PlaywrightAuthenticationService implements AuthenticationService {

	private static final Logger log = LoggerFactory.getLogger(PlaywrightAuthenticationService.class);
	...
	private final BrowserFactory browserCreator;

	private final WebAuthnDisabler webAuthnDisabler;

	public PlaywrightAuthenticationService(MigrosUserProperties userCredentials,
			PlaywrightProperties browserConfiguration, MigrosSelectorsProperties elementSelectors,
			BrowserFactory browserCreator, WebAuthnDisabler webAuthnDisabler) {
