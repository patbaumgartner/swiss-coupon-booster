...
/**
 * Parse a single Set-Cookie header into an immutable object. - Class name: CookieParser
 * (per request) - SameSite -> enum - Errors -> RuntimeException
 */
public final class CookieParser {
	...
	/** Parse a single Set-Cookie header value. Throws CookieParseException on error. */
