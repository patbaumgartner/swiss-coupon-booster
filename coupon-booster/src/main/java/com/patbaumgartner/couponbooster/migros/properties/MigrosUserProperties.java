...
/**
 * Configuration properties for Migros user authentication credentials.
 * <p>
...
@Validated
public record MigrosUserProperties(@Email(message = "Email must be valid") String email, String password) {
}
